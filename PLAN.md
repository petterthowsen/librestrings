...
- **The fundamental is weak on the low strings:** C string −9 to −16 dB of the harmonic power against −1 to −8 recorded (the recording's microphone distance and room may add to it; the body's low end is estimated, STATUS.md).
- **The model is about 10 dB cleaner** (HNR 37–45 dB against 26–34 dB) at every dynamic: there is no bow noise.
- **High positions on a lower string fail.** Notes 7–18 semitones up a string (sul C F#3–B3, sul G D4–G4, sul D B4–C#5, mostly at mf–ff) play 17–57 cents sharp with an HNR of 9–16 dB: not clean Helmholtz motion. The performer's own fingering never goes there near the nut, and the range tests don't cover it, but the bridge fingering mode (up to 12.5 semitones) does.
