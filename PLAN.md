...
- **Not done:** the violin, viola and bass keep μs 0.8. There is no measured attack data for them, and changing theirs means recalibrating each band and its seed sweep.
